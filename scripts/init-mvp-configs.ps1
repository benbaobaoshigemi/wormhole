...
$winConfig = @{
  ...
  transfer = @{ max_concurrent_tasks = 2; parallel_chunk_uploads = 4; chunk_size_bytes = 2097152; conflict_strategy = "rename"; min_free_space_bytes = 67108864; verify_hash = $true; resume_enabled = $true }
